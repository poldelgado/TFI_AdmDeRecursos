/*
 * File: app/view/procesos/tec/Tecnicos.js
 *
...
Ext.define('app.view.procesos.tec.Tecnicos', {
    extend: 'Ext.container.Container',
    alias: 'widget.tecnicos',

    requires: [
        'app.view.procesos.pve.ProvedoresViewModel1',
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    xtype: 'button',
                    handler: function(button, e) {
                        window.open('export_technicians','_blank');
                ...
                },
                {
                    ...
                    loadGrid: function() {
                        var ajax = app.controller.std.Glob.ajax,
                            json = ajax('GET', 'technicians',null);
